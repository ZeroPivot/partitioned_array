...
# def relative_id? (relative_id)
# puts 'Enter the relative id you want to search for:'
#  relative_id = gets.chomp.to_i
#  if relative_id.between?(0, 31)
#    puts "You entered #{relative_id}"
#  else
#    puts 'Invalid relative id'
#    relative_id = nil
#  end
# end

range_arr.each_with_index do |range, index|
  relative_id = range.bsearch { |element| rel_arr[element] >= 32 }
